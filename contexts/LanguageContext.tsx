...
export const translations = {
  en: {
    ...
    hero: {
      ...
      h1b: 'Fire Alarm',
      h1c: 'Technician',
      sub: 'Master the skills of Design, Supply, Installation, and Maintenance. Join a high-demand industry and start a career with limitless growth.',
    ...
    program: {
      ...
      certSub: 'Industry recognized credential upon completion',
    ...
    benefits: {
      ...
      certified: 'Certified',
      certifiedSub: 'Industry recognized',
      salary: 'Avg. Starting Potential',
    },
    socialProof: {
    ...
    footer: {
      copy: '\u00a9 2024 PowerTech Academy. All rights reserved.',
  ...
  es: {
    ...
    hero: {
      ...
      h1b: 'T\u00e9cnico de',
      h1c: 'Alarmas',
      sub: 'Domina las habilidades de Dise\u00f1o, Suministro, Instalaci\u00f3n y Mantenimiento. \u00danete a una industria de alta demanda y comienza una carrera con crecimiento ilimitado.',
    ...
    benefits: {
      ...
      items: [
        'Un\u00e9te a un sector de alto crecimiento con demanda estable.',
        'Apoyo integral para la colocaci\u00f3n laboral despu\u00e9s de graduarte.',
        'Apto para cualquier persona interesada en aprender una habilidad t\u00e9cnica.',
        'Avalado por expertos de la industria y grandes empresas de seguridad.',
      ],
      placementRate: 'Tasa de Colocaci\u00f3n',
      entryLevel: 'Nivel de Entrada',
      entryLevelSub: 'Accesible para todos',
      certified: 'Certificado',
      certifiedSub: 'Reconocido por la industria',
      salary: 'Potencial Salarial Inicial',
    },
    socialProof: {
    ...
    footer: {
      copy: '\u00a9 2024 PowerTech Academy. Todos los derechos reservados.',
