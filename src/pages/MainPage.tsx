...
import { Chip, Form } from "@heroui/react";

const TechBackground = lazy(() =>
  import('../../components/QuantumScene').then(m => ({ default: m.TechBackground }))
);
import { BentoGrid } from '../../components/Diagrams';
import { useLanguage } from '../../contexts/LanguageContext';
import { CheckCircle2, ArrowRight, Zap, ChevronDown, Send } from 'lucide-react';
import Header from '../../components/Header';
import { trackApplyNowClick, trackEnrollmentFormSubmit, trackWhatsAppClick } from '../utils/gtag';

// --- Subtle Reveal Helper ---
        ...
        <div className="space-y-3">
          {t.curriculum.modules.map((mod, i) => (
            <FadeIn key={i} delay={i * 0.1}>
              <details className="group bg-[#121212]/60 border border-white/10 backdrop-blur-md rounded-2xl mb-3 shadow-none data-[open=true]:border-[#FF4500]/30 [&_summary::-webkit-details-marker]:hidden">
